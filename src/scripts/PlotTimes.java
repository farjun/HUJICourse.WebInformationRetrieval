...
public class PlotTimes {
    static String[] words = new String[]{"dribble","clash", "pity", "satisfaction", "ballot","economic", "college",
            ...
            "innocent", "enhance", "award", "chimpanzee", "platform","strain", "fund", "date", "check", "order", "hurl",
            "shout","set","dynamic",
